...
export function QuickMLBar() {
  ...
  return (
    <form onSubmit={handleSearch} className="relative w-full max-w-3xl mx-auto mb-8 shadow-lg shadow-primary/5 rounded-full group">
      ...
      <Input
        type="text"
        className="block w-full pl-12 pr-24 py-6 text-base rounded-full border-primary/20 bg-card/80 backdrop-blur-sm focus-visible:ring-primary focus-visible:border-primary placeholder:text-muted-foreground/70 shadow-sm"
